...
# ── Ridge via Normal Equations (Stoer & Bulirsch §4.8) ───
# Ridge: minimise ||y - Ax||^2 + lambda * ||x||^2
# Solution: x = (A^T A + lambda*I)^{-1} A^T y
print("\nFitting Ridge regression via normal equations...")
